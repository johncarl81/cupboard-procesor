 ...
 */
public class CupboardProcessorInvocationBuilderStrategy implements InvocationBuilderStrategy {

    private final PublicInvocationBuilder publicInvocationBuilder;

    @Inject
    public CupboardProcessorInvocationBuilderStrategy(PublicInvocationBuilder publicInvocationBuilder) {
